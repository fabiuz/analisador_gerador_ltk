...
FUNCTION Abrir_Arquivo_Para_Gravar_Loteria(BYVAL strJogo AS STRING, BYVAL strPastaDestino AS STRING, BYREF uInsert_Jogo_Bolas AS LONG, _
    ...
    strInsert_Jogo_Bolas = strPastaDestino & strJogo & "_JOGO_BOLAS_INSERT_" & strTempo & ".sql"
    strWhere_Jogo_Bolas = strPastaDestino & strJogo & "_JOGO_BOLAS_WHERE_" & strTempo & ".sql"
    strInsert_Jogo_Combinacoes = strPastaDestino & strJogo &  "_INSERT_BOLAS_COMBINADAS_" & strTempo & ".sql"
    strWhere_Jogo_Combinacoes = strPastaDestino & strJogo &  "_WHERE_BOLAS_COMBINADAS_" & strTempo & ".sql"
...
INSERIR_COMBINACAO_LOTERIA:
    ...
    IF quantidade_de_combinacoes MOD 5 THEN
        ...
        MSGBOX FILENAME$(uInsert_Jogo_Bolas)
        CLOSE
        EXIT FUNCTION
    END IF
