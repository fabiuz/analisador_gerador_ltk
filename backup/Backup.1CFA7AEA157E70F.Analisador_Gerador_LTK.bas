...
FUNCTION Abrir_Arquivo_Para_Gravar_Loteria(BYVAL strJogo AS STRING, BYVAL strPastaDestino AS STRING, BYREF uInsert_Jogo_Bolas, _
    ...
    strInsert_Jogo_Bolas = strJogo & "_JOGO_BOLAS_INSERT_" & strTempo & ".txt"
    strWhere_Jogo_Bolas = strJogo & "_JOGO_BOLAS_WHERE_" & strTempo & ".txt"
    strInsert_Jogo_Combinacoes = strJogo & "_JOGO_BOLAS_COMBINADAS_INSERT_" & strTempo & ".txt"
    strWhere_Jogo_Combinacoes = strJogo & "_JOGO_BOLAS_COMBINADAS_WHERE_" & strTempo & ".txt"
