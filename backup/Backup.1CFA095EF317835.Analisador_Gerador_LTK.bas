...
'
SUB Carregar_Lista_Inicial() AS LONG
    COMBOBOX RESET hJanela_Principal, %IDC_CMB_JOGO_TIPO
    COMBOBOX RESET hJanela_Principal, %IDC_CMB_APOSTAR_COM_TODAS
    '
    COMBOBOX ADD hJanela_Principal, %IDC_CMB_JOGO_TIPO, "QUINA"
    COMBOBOX ADD hJanela_Principal, %IDC_CMB_JOGO_TIPO, "MEGASENA"
    COMBOBOX ADD hJanela_Principal, %IDC_CMB_JOGO_TIPO, "LOTOFACIL"
    COMBOBOX ADD hJanela_Principal, %IDC_CMB_JOGO_TIPO, "LOTOMANIA"
    ...
    '
    COMBOBOX SELECT hJanela_Principal, %IDC_CMB_JOGO_TIPO, 1
    COMBOBOX SELECT hJanela_Principal, %IDC_CMB_APOSTAR_COM_TODAS, 1
END SUB
