...
FUNCTION Gerar_Combinacao_Por_Jogo(BYVAL strJogo AS STRING, BYVAL uBolasApostadas AS LONG,
    BYREF strBolas(), BYVAL uArquivoDestino, BYREF strErro AS STRING) AS LONG
    ...
    ' Vamos otimizar para cada tipo de jogo
    SELECT CASE
        ...
        FOR uColuna2 = uColuna1 + 1 TO uLimiteSuperior
            FOR uColuna3 = uColuna2 + 1 TO uLimiteSuperior
                FOR uColuna4 = uColuna3 + 1 TO uLimiteSuperior
                    GOSUB VERIFICAR_QUINA_COM_5_NUMEROS
                NEXT uColuna5
            NEXT uColuna3
        NEXT uColuna2
    NEXT uColuna1
...
VERIFICAR_QUINA_COM_5_NUMEROS:
    FOR uColuna5 = uColuna4 + 1 TO uLimiteSuperior
        IF strJogo = "QUINA" AND uBolasApostadas = 5 THEN
            strTexto = "QUINA;" & strBolas(uColuna1) & ";" & strBolas(uColuna2) & ";" & strBolas(uColuna3) & ";"
            ...
            RETURN
        ELSE
            GOSUB VERIFICAR_QUINA_COM_6_NUMEROS
            RETURN
        END IF
    NEXT uColuna5

VERIFICAR_QUINA_COM_6_NUMEROS:
    FOR uColuna6 = uColuna5 + 1 TO uLimiteSuperior
        IF strJogo = "QUINA" AND uBolasApostadas = 6 THEN
            ...
            FOR uColuna3 = uColuna2 + 1 TO uLimiteSuperior
                FOR uColuna4 = uColuna3 + 1 TO uLimiteSuperior
                    FOR uColuna5 = uColuna4 + 1 TO uLimiteSuperior
                        DIALOG DOEVENTS
                        IF uSair = 1 THEN
                            DIALOG HIDE hJanela_Aguarde
                            CLOSE
                            EXIT FUNCTION
                        END IF

                        ' Para a quina com 5 números
                        ...
                        IF strJogo = "QUINA" THEN
                            ...
                            uContador += 1
                            '
                            IF uAtualizar = 1 THEN
                                CONTROL SET TEXT hJanela_aguarde, %IDC_MENSAGEM, strTexto
                                strTitulo = FORMAT$(uContador, "###,###")
                                DIALOG SET TEXT hJanela_Aguarde, strTitulo
                            END IF
                        ELSE
                            FOR uColuna6 = uColuna5 + 1 TO uLimiteSuperior
                                DIALOG DOEVENTS
                                IF uSair = 1 THEN
                                    ...
                                    EXIT FUNCTION
                                END IF
                                IF strJogo = "MEGASENA" THEN
                                    strTexto = "MEGASENA;" & strBolas(uColuna1) & ";" & strBolas(uColuna2) & ";" & strBolas(uColuna3) & ";"
                                                                ...
                                                                FOR uColuna14 = uColuna13 + 1 TO uLimiteSuperior
                                                                    FOR uColuna15 = uColuna14 + 1 TO uLimiteSuperior
                                                                        ...
                                                                        IF uSair = 1 THEN
                                                                            ...
                                                                            EXIT FUNCTION
                                                                        END IF
                                                                        strTexto = "LOTOFACIL;" & strBolas(uColuna1) & ";" & strBolas(uColuna2) & ";" & strBolas(uColuna3) & ";"
                                                                        strTexto = strTexto & strBolas(uColuna4) & ";" & strBolas(uColuna5) & ";" & strBolas(uColuna6) & ";"
                                                                        strTexto = strTexto & strBolas(uColuna7) & ";" & strBolas(uColuna8) & ";" & strBolas(uColuna9) & ";"
                                                                        strTexto = strTexto & strBolas(uColuna10) & ";" & strBolas(uColuna11) & ";" & strBolas(uColuna12) & ";"
                                                                        strTexto = strTexto & strBolas(uColuna13) & ";" & strBolas(uColuna14) & ";" & strBolas(uColuna15)
                                                                        PRINT #uArquivoDestino, strTexto
                                                                        IF ERR <> 0 THEN
                                                                            strErro = "Erro: " & ERROR$(ERR)
                                                                            FUNCTION = -1
    ...
    strContador = FORMAT$(uContador, "###,")
    REPLACE "," WITH "." IN strContador


    MSGBOX  "Executado com sucesso!!!" & $CRLF & "Gerado " & strContador & " combinações para o jogo '" & _
            strJogo & "' com apostas " & FORMAT$(uBolasApostadas) & " números."
    DIALOG HIDE hJanela_Aguarde
            ...
            SELECT CASE AS LONG CB.CTL
                ...
                CASE %IDC_GERAR_TODAS
                    IF CB.CTLMSG = %BN_CLICKED THEN
                        ...
                        MSGBOX "Jogo: " & strJogoSelecionado & ", aposta: " & strApostaSelecionado
