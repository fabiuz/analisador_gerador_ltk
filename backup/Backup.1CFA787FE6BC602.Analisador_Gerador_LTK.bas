...
FUNCTION Validar_Campos_Loteria (BYVAL strArquivoOrigem AS STRING, BYVAL strLinhas() AS STRING, BYREF uLinhas AS LONG, BYREF uCampos AS LONG, BYREF strErro) AS LONG
    ...
    LOCAL uCampos_Quantidade, uCampos_Quantidade_Anterior AS LONG
    uCampos_Quantidade = PARSECOUNT(strlinhas(1)
