...
GLOBAL objRelatorioInicial AS IPOWERTIME
...
#ENDIF
    ...
    objRelatorioFinal.TimeDiff(objRelatorioInicial, uSinalFinal, BYVAL 0, uHoraInsertDecorrido, uMinutoInsertDecorrido, _
