...
FUNCTION Combinacao(BYVAL strTexto AS STRING, BYVAL strDelimitador AS STRING, BYREF strCombinacoes() AS STRING, BYREF strErro AS STRING) AS LONG
    ...
    LET combinados_Colecao = CLASS "ILinkListCollection "
    IF ISOBJECT(combinados_Colecao) THEN
...
#PBFORMS BEGIN DIALOG %IDD_DIALOG1->->
    ...
    CONTROL ADD TEXTBOX,  hDlg, %TXT_TESTE, "", 285, 190, 265, 13
    CONTROL ADD BUTTON,   hDlg, %BTN_TESTE, "&Testar", 500, 205, 50, 15
    CONTROL ADD LISTBOX,  hDlg, %LST_TESTE, , 285, 205, 100, 190
    CONTROL ADD LABEL,    hDlg, %LBL_TESTE, "", 390, 210, 100, 10
#PBFORMS END DIALOG
