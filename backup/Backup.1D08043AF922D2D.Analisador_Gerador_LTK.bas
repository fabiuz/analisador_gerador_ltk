        ...
        CASE %WM_COMMAND
            ...
            SELECT CASE AS LONG CB.CTL
                ...
                CASE %BTN_PAUSAR_TESTE
                    uPausarTeste = IIF(uPararTeste = 0, 1, 0)
                ...
                CASE %BTN_TESTE
                    ...
                    IF Combinacao(strTeste, ";", strCombinacao(), strErro) = -1 THEN
...
#PBFORMS BEGIN DIALOG %IDD_DIALOG1->->
    ...
    DIALOG NEW hParent, "Analisador e Gerador - LTK", 278, 92, 563, 399, _
    ...
    CONTROL ADD LABEL,    hDlg, %LBL_TESTE, "", 285, 380, 270, 10, %WS_CHILD _
