...
FUNCTION Carregar_Lista(BYVAL strJogo AS STRING) AS LONG
    COMBOBOX RESET hJanela_Principal, %IDC_CMB_APOSTAR_COM

    strJogo = UCASE$(strJogo)
    SELECT CASE strJogo
        CASE "QUINA"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "5 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "6 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "7 números"

        CASE "MEGASENA
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "6 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "7 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "8 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "9 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "10 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "11 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "12 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "14 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "15 números"

        CASE "LOTOFACIL"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "15 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "16 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "17 números"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "18 números"

        CASE "LOTOMANIA"
            COMBOBOX ADD hJanela_Principal, %IDC_CMB_APOSTAR_COM, "50 números"
    END SELECT

    COMBOBOX SELECT hJanela_Principal, %IDC_CMB_APOSTAR_COM, 1
    COMBOBOX SELECT hJanela_Principal, %IDC_CMB_QT_JOGOS, 1
