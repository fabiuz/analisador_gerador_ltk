...
FUNCTION Abrir_Arquivo_Para_Gravar_Loteria(BYVAL strJogo AS STRING, BYVAL strPastaDestino AS STRING, BYREF uInsert_Jogo_Bolas AS LONG, _
    ...
    strInsert_Jogo_Bolas = strPastaDestino & strJogo & "_JOGO_BOLAS_INSERT_000001" & strTempo & ".sql"
    strWhere_Jogo_Bolas = strPastaDestino & strJogo & "_JOGO_BOLAS_WHERE_000001" & strTempo & ".sql"
    strInsert_Jogo_Combinacoes = strPastaDestino & strJogo &  "_INSERT_BOLAS_COMBINADAS_000001" & strTempo & ".sql"
    strWhere_Jogo_Combinacoes = strPastaDestino & strJogo &  "_WHERE_BOLAS_COMBINADAS_000001" & strTempo & ".sql"
...
FUNCTION Gerar_Insert_Where_Resultado_Loteria(BYVAL strArquivoOrigem AS STRING, BYVAL strPastaDestino AS STRING, BYREF strErro AS STRING) AS LONG
    ...
    IF  strJogo <> "QUINA" AND strJogo <> "MEGASENA" AND strJogo <> "LOTOFACIL" AND strJogo <> "LOTOMANIA" AND _
        strJogo <> "INTRALOT_MINAS_5" AND strJogo <> "INTRALOT_LOTO_MINAS" THEN
    ...
    FOR uA = 2 TO uLinhas
        CONTROL SET TEXT hJanela_Principal, %IDC_LOG_LOTERIA, "Linha: " & FORMAT$(uA, "000000")
        DIALOG DOEVENTS
        '
        ' Carregar arranjo
        ...
        FOR uColuna1 = 1 TO uQuantidade_de_Bolas
            uIndice(1) = uColuna1
            uLimite = 1
...
INSERIR_COMBINACAO_LOTERIA:
    ...
    ' A cada 250 mil combinações iremos gerar, um novo arquivo de insert
    IF quantidade_de_combinacoes MOD 5 THEN
        DIM strArquivo AS STRING

        strArquivo = FILENAME$(uInsert_Jogo_Bolas)
        IF strArquivo <> "" THEN
            DIM uPosicao AS LONG
            uPosicao = INSTR(strArquivo, "000001.sql")
            IF uPosicao = 0 THEN
                MSGBOX "Arquivo não termina em '000001.sql'.", %MB_ICONERROR
                CLOSE
                EXIT FUNCTION
            END IF
            strArquivo = MID$(strArquivo, 1, uPosicao - 1) & "_" & FORMAT$(uContar_Grupo, "000000") & ".sql"
    ...
    END IF
        ...
        'PRINT #uInsert_Jogo_Combinacoes, strInsert_Jogo_Bolas_Combinadas
        'PRINT #uWhere_Jogo_Bolas, strWhere_Jogo_Bolas
        'PRINT #uWhere_Jogo_Combinacoes, strWhere_Jogo_Bolas_Combinadas
    ...
    ' Vamos contabilizar quantidade de quadrantes e quantidade de números pares, para cada combinação
    LOCAL uQuadrante1, uQuadrante2, uQuadrante3, uQuadrante4 AS LONG
    LOCAL uOctante1, uOctante2, uOctante3, uOctante4, uOctante5, uOctante6, uOctante7, uOctante8 AS LONG
    ...
    FOR lngA = 1 TO uLimite
        ...
        ' Vamos contabilizar a quantidade de números pares e impares, para cada combinação
        IF uNumero MOD 2 = 0 THEN
        ...
        SELECT CASE strJogo
            CASE "QUINA"
                SELECT CASE uNumero
                    CASE 1 TO 20
                        uQuadrante1 += 1
                        IF uNumero >= 1 AND uNumero <= 10 THEN
                            uOctante1 += 1
                        ELSE
                            uOctante2 += 1
                        END IF
                    ...
                    CASE 21 TO 40
                        uQuadrante2 += 1
                        IF uNumero >= 21 AND uNumero <= 30 THEN
                            uOctante3 += 1
                        ELSE
                            uOctante4 += 1
                        END IF
                    ...
                    CASE 41 TO 60
                        uQuadrante3 += 1
                        IF uNumero >= 41 AND uNumero <= 50 THEN
                            uOctante5 += 1
                        ELSE
                            uOctante6 += 1
                        END IF
                    CASE 61 TO 80
                        uQuadrante4 += 1
                        IF uNumero >= 61 AND uNumero <= 70 THEN
                            uOctante6 += 1
                        ELSE
                            uOctante7 += 1
                        END IF
            ...
            CASE "LOTOFACIL"
                SELECT CASE uNumero
                    CASE 1 TO 6
                        uQuadrante1 += 1
                        IF uNumero >= 1 AND uNumero <= 3 THEN
                            uOctante1 += 1
                        ELSE
                            uOctante2 += 1
                        END IF
                    ...
                    CASE 7 TO 12
                        uQuadrante2 += 1
                        IF uNumero >= 7 AND uNumero <= 9 THEN
                            uOctante3 += 1
                        ELSE
                            uOctante4 += 1
                        END IF
                    ...
                    CASE 13 TO 18
                        uQuadrante3 += 1
                        IF uNumero >= 13 AND uNumero <= 15 THEN
                            uOctante5 += 1
                        ELSE
                            uOctante6 += 1
                        END IF
                    CASE 19 TO 25
                        uQuadrante4 += 1
                        IF uNumero >= 19 AND uNumero <= 21 THEN
                            uOctante7 += 1
                        ELSE
                            uOctante8 += 1
                        END IF
            ...
            CASE "INTRALOT_MINAS_5"
                SELECT CASE uNumero
                    CASE 1 TO 8
                        ...
                        '
                        ' Octante
                        IF uNumero >= 1 AND uNumero <= 4 THEN
                            uOctante1 += 1
                        ELSE
                            uOctante2 += 1
                        END IF
                    ...
                    CASE 9 TO 16
                        ...
                        '
                        ' Octante
                        IF uNumero >= 9 AND uNumero <= 12 THEN
                            uOctante3 += 1
                        ELSE
                            uOctante4 += 1
                        END IF
                    ...
                    CASE 17 TO 24
                        ...
                        '
                        ' Octante
                        IF uNumero >= 17 AND uNumero <= 20 THEN
                            uOctante5 += 1
                        ELSE
                            uOctante6 += 1
                        END IF
                    ...
                    CASE 25 TO 34
                        ...
                        '
                        ' Octante
                        IF uNumero >= 25 AND uNumero <= 28 THEN
                            uOctante7 += 1
                        ELSE
                            uOctante8 += 1
                        END IF
    ...
    strInsert_Jogo_Bolas = "INSERT INTO LTK.JOGO_BOLAS (JOGO_TIPO, CONCURSO, DATA, BOLAS_COMBINADAS, BOLAS_COMBINADAS_QT, BOLAS_COMBINADAS_BASE, BOLAS_COMBINADAS_BASE_QT, "
    strInsert_Jogo_Bolas += "QT_DE_PARES, QT_DE_IMPARES, QT_QUADRANTE_1, QT_QUADRANTE_2, QT_QUADRANTE_3, QT_QUADRANTE_4, "
    strInsert_Jogo_Bolas += "QT_OCTANTE_1, QT_OCTANTE_2, QT_OCTANTE_3, QT_OCTANTE_4, QT_OCTANTE_5, QT_OCTANTE_6, QT_OCTANTE_7, QT_OCTANTE_8) VALUES ("
    ...
    strInsert_Jogo_Bolas += "'" & FORMAT$(uQuantidade_de_Bolas) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uQuantidade_de_Pares) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uQuantidade_de_Impares) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uQuadrante1) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uQuadrante2) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uQuadrante3) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uQuadrante4) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante1) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante2) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante3) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante4) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante5) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante6) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante7) & "', "
    strInsert_Jogo_Bolas += "'" & FORMAT$(uOctante8) & "');" & $CRLF

    DIM strInsert_Jogo_Bolas_Combinadas AS STRING
    '
    strInsert_Jogo_Bolas_Combinadas = "INSERT INTO LTK.JOGO_BOLAS_COMBINADAS (JOGO_TIPO, BOLAS_COMBINADAS, BOLAS_COMBINADAS_QT, BOLAS_COMBINADAS_BASE, BOLAS_COMBINADAS_BASE_QT, "
    strInsert_Jogo_Bolas_Combinadas += "QT_DE_PARES, QT_DE_IMPARES, QT_QUADRANTE_1, QT_QUADRANTE_2, QT_QUADRANTE_3, QT_QUADRANTE_4, "
    strInsert_Jogo_Bolas_Combinadas += "QT_OCTANTE_1, QT_OCTANTE_2, QT_OCTANTE_3, QT_OCTANTE_4, QT_OCTANTE_5, QT_OCTANTE_6, QT_OCTANTE_7, QT_OCTANTE_8) VALUES ("
    strInsert_Jogo_Bolas_Combinadas += "'" & strCampos(1) + "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & strBolas_Combinadas & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uLimite) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & strBolas_Conjunto & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uQuantidade_de_Bolas) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uQuantidade_de_Pares) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uQuantidade_de_Impares) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uQuadrante1) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uQuadrante2) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uQuadrante3) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uQuadrante4) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante1) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante2) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante3) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante4) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante5) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante6) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante7) & "', "
    strInsert_Jogo_Bolas_Combinadas += "'" & FORMAT$(uOctante8) & "');" & $CRLF

    DIM strWhere_Jogo_Bolas AS STRING
    '
    strWhere_Jogo_Bolas =  "Select * from JOGO_BOLAS WHERE "
    strWhere_Jogo_Bolas += "JOGO_TIPO = '" & strCampos(1) & "' AND "
    strWhere_Jogo_Bolas += "CONCURSO = '" & strCampos(2) & "' AND "
    strWhere_Jogo_Bolas += "BOLAS_COMBINADAS = '" & strBolas_Combinadas & "';"

    DIM strWhere_Jogo_Bolas_Combinadas AS STRING
    strWhere_Jogo_Bolas_Combinadas = "Select * from JOGO_BOLAS_COMBINADAS WHERE "
    strWhere_Jogo_Bolas_Combinadas += "JOGO_TIPO = '" & strCampos(1) & "' AND "
    strWhere_Jogo_Bolas_Combinadas += "BOLAS_COMBINADAS_BASE = '" & strBolas_Conjunto & "';"
...
#PBFORMS BEGIN DIALOG %IDD_DIALOG1->->
    ...
    DIALOG NEW hParent, "Analisador e Gerador - LTK", 47, 70, 562, 403, _
