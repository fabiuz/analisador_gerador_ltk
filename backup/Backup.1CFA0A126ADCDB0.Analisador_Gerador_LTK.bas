            ...
            SELECT CASE AS LONG CB.CTL
                ...
                CASE %IDC_GERAR_TODAS
                    IF CB.CTLMSG = %BN_CLICKED THEN
                        ...
                        COMBOBOX GET SELECT hJanela_Principal, %IDC_CMB_JOGO_TIPO_TODAS TO uApostaIndiceSelecionado
                        COMBOBOX GET TEXT hJanela_Principal, %IDC_CMB_JOGO_TIPO_TODAS, uIndice TO strApostaSelecionado
