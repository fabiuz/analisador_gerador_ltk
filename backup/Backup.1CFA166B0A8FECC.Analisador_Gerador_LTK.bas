...
GLOBAL uAtualizar AS LONG
GLOBAL uSair AS LONG
        ...
        CASE %WM_COMMAND
            ...
            SELECT CASE AS LONG CB.CTL
                ...
                CASE %IDC_CHK_ATUALIZAR_TODAS
                    IF CB.CTLMSG = %BN_CLICKED THEN
                        CONTROL GET CHECK hJanela_Principal, %IDC_CHK_ATUALIZAR_TODAS TO uAtualizar
                    END IF
...
#PBFORMS BEGIN DIALOG %IDD_DIALOG1->->
    ...
    CONTROL ADD CHECKBOX, hDlg, %IDC_CHK_ATUALIZAR_TODAS, "Verificar status " + _
        "da geração", 10, 105, 100, 10
    CONTROL ADD BUTTON,   hDlg, %IDC_BTN_GERAR_TODAS, "Gerar", 165, 100, 50, _
        15
    ...
    CONTROL ADD LABEL,    hDlg, %IDC_LBL_LOG_TODAS, "", 10, 65, 205, 15
    ...
    CONTROL ADD BUTTON,   hDlg, %IDC_BTN_PARA_TODAS, "&Parar", 110, 100, 50, _
