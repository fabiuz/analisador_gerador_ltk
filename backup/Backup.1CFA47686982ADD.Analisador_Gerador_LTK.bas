               ...
               CASE %IDC_TXT_ARQUIVO_ORIGEM, %IDC_TXT_PASTA_DESTINO_INSERT
                ...
                CASE %IDC_BTN_GERAR_INSERT
                    ...
                    IF CB.CTLMSG = %BN_CLICKED THEN
                        ...
                        CONTROL GET TEXT hJanela_Principal, %IDC_TXT_PASTA_DESTINO_INSERT TO strPastaDestino
                    END IF
                    ...
                    IF Gerar_Insert_Where_Todas_Combinacoes(strArquivoOrigemInsert, strPastaDestino, strErro) = -1 THEN
                        MSGBOX strErro, %MB_ICONERROR
                        EXIT FUNCTION
                    ELSE
                        MSGBOX "Executado com sucesso!!!"
