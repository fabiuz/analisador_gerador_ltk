...
FUNCTION Abrir_Arquivo_Para_Gravar_Loteria(BYVAL strJogo AS STRING, BYVAL strPastaDestino AS STRING, BYREF uInsert_Jogo_Bolas AS LONG, _
    ...
    strInsert_Jogo_Combinacoes = strPastaDestino & strJogo &  "_JOGO_BOLAS_COMBINADAS_INSERT_" & strTempo & ".sql"
    strWhere_Jogo_Combinacoes = strPastaDestino & strJogo &  "_JOGO_BOLAS_COMBINADAS_WHERE_" & strTempo & ".sql"
