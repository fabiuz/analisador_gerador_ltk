...
INSERIR_COMBINACAO_LOTERIA:
    ...
    IF (quantidade_de_combinacoes MOD 229370 = 0) AND TRIM$(strCampos(1)) = "LOTOFACIL" THEN
    ...
    FOR lngA = 1 TO uLimite
        ...
        SELECT CASE strJogo
            CASE "QUINA"
                SELECT CASE uNumero
                    CASE 1 TO 5, 11 TO 15, 21 TO 25, 31 TO 35
                        uQuadrante1 += 1

                    CASE 6 TO 10, 16 TO 20, 26 TO 30, 36 TO 40
                        uQuadrante2 += 1
    ...
    strInsert_Jogo_Bolas += "'" & strBolas_Conjunto & "'); " & $CRLF
    ...
    'strInsert_Jogo_Bolas += "'" & FORMAT$(uQuadrante4) & "'); " & $CRLF
