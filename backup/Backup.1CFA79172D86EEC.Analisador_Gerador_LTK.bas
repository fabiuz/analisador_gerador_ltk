...
FUNCTION Validar_Campos_Loteria (BYVAL strArquivoOrigem AS STRING, BYREF strLinhas_Campos() AS STRING, BYREF uLinhas AS LONG, BYREF uCampos AS LONG, BYREF strErro) AS LONG
