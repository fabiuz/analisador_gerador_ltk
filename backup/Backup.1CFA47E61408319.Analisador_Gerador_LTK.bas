...
GLOBAL uMinutoInsert, uSegundoInsert, uMiSegundoInsert AS LONG
...
FUNCTION Gerar_Insert_Where_Todas_Combinacoes(BYVAL strArquivoOrigem AS STRING, BYVAL strPastaDestino AS STRING, BYREF strErro AS STRING) AS LONG
    ...
    uWhere = FREEFILE
    uInsert = FREEFILE
    strWhere = strPastaDestino & strCampos(1) & "_COM_" & strCampos(3) & "_WHERE" & strTempo & ".txt"
    strInsert = strPastaDestino &  strCampos(1) & "_COM_" & strCampos(3) & "_INSERT" & strTempo & ".txt"
...
#ENDIF
        ...
        objDepois.now()
        objDepois.TimeDiff(objAgora, BYVAL 0, BYVAL 0, BYVAL 0, uMinutoInsert, uSegundoInsert, uMiSegundoInsert, BYVAL 0)
...
SUB Gerar_Arquivo_Insert_Where_Todas_Combinacoes(BYVAL strJogo AS STRING,  BYVAL strJogoSubTipo AS STRING, _
    ...
    IF uAtualizarInsert = 1 THEN
        strTexto =  "Linha: " & FORMAT$(uLinhaInsert, "000000000,") & ", " & _
                    FORMAT$(uCombinacoesInsert, "000000000,") & " já processadas. " & $CRLF & _
                    "Tempo: " + FORMAT$(uMinutoInsert, "00") & "min," & FORMAT$(uSegundoInsert, "00") & "sec," & _
                    FORMAT$(uMiSegundoInsert, "00") & ", BOLAS_CONJUNTO: '" & _
