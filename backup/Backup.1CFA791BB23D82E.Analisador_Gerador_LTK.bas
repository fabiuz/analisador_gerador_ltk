...
FUNCTION Validar_Campos_Loteria (BYVAL strArquivoOrigem AS STRING, BYREF strLinhas_Campos() AS STRING, BYREF uLinhas AS LONG, BYREF uCampos AS LONG, BYREF strErro AS STRING) AS LONG
    ...
    LOCAL uCampos_Quantidade
    uCampos_Quantidade = PARSECOUNT(strlinhas(1), ANY ";")

    REDIM strLinhas_Campos(1 TO uLinhas, 1 TO uCampos_Quantidade)
    ...
    FOR uA = 1 TO uLinhas
        ...
        PARSE strLinhas(ua), strLinhas_Campos(1, 1), ANY ";"
    NEXT uA
