...
FUNCTION Gerar_Insert_Where_Todas_Combinacoes(BYVAL strArquivoOrigem AS STRING, BYVAL strPastaDestino AS STRING, BYREF strErro AS STRING) AS LONG
    ...
    uWhere = FREEFILE
    uInsert = FREEFILE
    strWhere = strPastaDestino &  "WHERE_" & strCampos(1) & "_COM_" & strCampos(3) & strTempo & ".txt"
    strInsert = strPastaDestino &  "_INSERT" & strCampos(1) & "_COM_" & strCampos(3) & strTempo & ".txt"
