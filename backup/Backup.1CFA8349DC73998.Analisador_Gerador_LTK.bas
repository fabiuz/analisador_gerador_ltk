            ...
            SELECT CASE AS LONG CB.CTL
               ...
               CASE %IDC_TXT_ARQUIVO_ORIGEM, %IDC_TXT_PASTA_DESTINO_INSERT
                ...
                CASE %IDC_BTN_GERAR_LOTERIA
                    ...
                    DIM strPasta_Destino_Loteria AS STRING

                    CONTROL GET TEXT hJanela_Principal, %IDC_TXT_ARQUIVO_LOTERIA TO strArquivo_Loteria
                    CONTROL GET TEXT hJanela_Principal, %IDC_TXT_

                    IF Gerar_Insert_Where_Resultado_Loteria("C:\Meus_Documentos\Power_Basic\LTK\MEGASENA_TODOS_CONCURSOS_ATÉ_23072014.csv", "C:\TMP\", strErro) = -1 THEN
                        MSGBOX strErro, %MB_ICONERROR
                    END IF
