...
FUNCTION Gerar_Insert_Where_Todas_Combinacoes(BYVAL strArquivoOrigem AS STRING, BYVAL strPastaDestino AS STRING, BYREF strErro AS STRING) AS LONG
    ...
    uLimite = VAL(strCampos(3))
    REDIM uIndice(1 TO uLimite)
    REDIM uBolas(1 TO uLimite)
    ...
    DO WHILE ISFALSE EOF(uArquivoOrigem)
        ...
        DIM uCamposQuantidade = PARSECOUNT(strLinha, ANY "_;")
        ...
        IF ISFALSE(strCampos(1) & "_" & strCampos(2) & "_" & strCampos(3) = strJogoSubTipo) THEN
        ...
        IF VAL(strCampos(3) <> uCamposQuantidade - 4
        ...
        ' Verifica se as bolas estão dentro da faixa para o jogo permitido
        ' Se chegamos até aqui, quer dizer, que correspondem aos mesmos dados quando
        ' da primeira vez que abrimos o arquivo
        DIM uForaFaixa AS LONG

        ' Faz o scaneamento, a partir do 5.º índice para verificar
        ' se está fora da faixa
        ARRAY SCAN strCampos(5), < uLimiteInferior AND > uLimiteSuperior, TO uForaFaixa
