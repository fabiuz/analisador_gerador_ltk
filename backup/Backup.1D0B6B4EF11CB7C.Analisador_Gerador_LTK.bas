...
FUNCTION Validar_Campos_Loteria (BYVAL strArquivoOrigem AS STRING, BYREF strLinhas() AS STRING, BYREF strErro AS STRING) AS LONG
    ...
    FOR uA = 2 TO uLinhas
        ...
        IF uData_Dia < 1 AND uData_Dia > 31 THEN
        ...
        IF uData_Mes < 1 AND uData_Mes > 12 THEN
            strErro  = "Erro, linha " + FORMAT$(uA) + ", campo 3, formato de data inválido: '" + strCampos(3) + "'." + $CRLF
            strErro += "O intervalo válido deve estar entre 1 e 12."
            FUNCTION = -1
            EXIT FUNCTION
        END IF
        ...
        ELSEIF uData_Dia = 30 THEN
            SELECT CASE uData_Mes
                CASE 4, 6, 9, 11
                    ' Não faz nada, rsrs.
